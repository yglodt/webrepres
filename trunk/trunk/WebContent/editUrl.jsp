...
<form name='editUrl' action='<c:url value="/Controller" />' method='post'>
<input type='hidden' name='action' value='edit' />
<input type='hidden' name='id' value='${c.id}' />
<input type='hidden' name='ctid' value='${param.ctid}' />
<table>
<tr><th>Title</th>
<td><input type="text" name='title' size='100' value='${c.title}' /></td></tr>
<tr><th>Url</th>
<td><input type="text" name='url' size='100' value='${c.url}' /></td></tr>
<tr><th>Width</th>
<td><input type="text" name='width' size='100' value='${c.width}' /></td></tr>
<tr><th>Height</th>
<td><input type="text" name='height' size='100' value='${c.height}' /></td></tr>
<tr><th>Extra CSS</th>
<td><input type="text" name='css' size='100' value='${c.css}' /></td></tr>
